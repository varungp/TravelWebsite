...
**Now, let's look at how Revenue/Transaction and Transactions vary with device type (Desktop, Mobile and Tablet):**

```{r, echo=FALSE, message=FALSE, prompt=FALSE, results='asis'}
mobileRevenuePerTransactionDataFrame <- gadata2[gadata2$Mobile == 1,]
...
tabletRevenuePerTransactionDataFrame <- gadata2[gadata2$Tablet == 1,]
...
desktopRevenuePerTransactionDataFrame <- gadata2[gadata2$Desktop == 1,]
...
# Make y axis with horizontal labels that display ticks at 
# every 4 marks. 4*0:g_range[2] is equivalent to c(0,4,8,12).
axis(2, las=1, at=800*0:t_range[2])
# Create box around plot
box()
# Create a title with a red, bold/italic font
...
```{r, echo=FALSE, message=FALSE, prompt=FALSE, results='asis'}
mobileTransactionPerPageViewsDataFrame <- gadata2[gadata2$Mobile == 1,]
...
tabletTransactionPerPageViewsDataFrame <- gadata2[gadata2$Tablet == 1,]
...
desktopTransactionPerPageViewsDataFrame <- gadata2[gadata2$Desktop == 1,]
